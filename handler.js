...
owner: `✪ EL COMANDO *${comando}* SOLO PUEDE SER USADO POR LOS MODERADORES DEL BOT.`, 
mods: `✪ EL COMANDO *${comando}* SOLO LO PUEDEN USAR LOS MODERADORES DEL BOT.`, 
premium: `✪ EL COMANDK *${comando}* SOLO PUEDE SER USADO POR USUARIOS PREMIUM.`, 
group: `✪ EL COMANDO *${comando}* SOLO PUEDE SER USADO EN GRUPOS.`,
private: `✪ EL COMANDO *${comando}* SOLO PUEDE SER USADO AL PRIVADO.`,
admin: `✪ EL COMANDO *${comando}* SOLO SE PUEDE USAR POR LOS ADMINS.`, 
botAdmin: `✪ PARA USAR ESTE COMANDO *${comando}* OCUPO SER ADMIN DEL GRUPO.`,
unreg: `*✪ NO ESTAS REGISTRADO* Y NO PUEDES USAR EL COMANDO *${comando}*          REGISTRATE CON EL COMANDO:\n> » #${verifyaleatorio} ${user2}.${edadaleatoria}`,
